...
public class KickoutSessionControlFilter  extends AccessControlFilter{
    ...
    //踢出状态，true标示踢出
    private final static String KICKOUT_STATUS = KickoutSessionControlFilter.class.getCanonicalName()+ "_kickout_status";
    ...
    protected boolean isAccessAllowed(ServletRequest request,
        ...
        String jedisSessionId = jedisUtil.get(userName);
        ...
        if(null!=jedisSessionId && jedisSessionId.equals((String)sessionId)){
            ...
            jedisUtil.setex(userName,3600, (String)sessionId);
            return Boolean.TRUE;
        }
    ...
    protected boolean onAccessDenied(ServletRequest request,
        ...
        //再重定向
        WebUtils.issueRedirect(request, response,"/admin/manage/login");
        return false;
    }
