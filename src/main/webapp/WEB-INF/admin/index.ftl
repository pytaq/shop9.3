	   ...
	   <!--右侧部分开始-->
	    <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <a href="${ctx}/admin/manage/user/logout" class="roll-nav roll-right J_tabExit">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx }/admin/manage/home" frameborder="0" data-id="home_jsp" seamless></iframe>
            </div>
