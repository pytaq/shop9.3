                ...
                <div class="panel-body">
                    <form class="form-inline">
                        <div class="form-group">
                            <label >用户名称</label>
                            <input type="text" class="form-control" id="search_username" name="username" placeholder="支持模糊查询">
                        </div>

                        <button type="button" class="btn btn-primary" id="btnSearch">查询</button>

                        <input type="hidden" id="power" value="1,2,3,4">
            ...
            <div class="modal-body">
                <form class="form-horizontal"  id="editForm">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input data-bv-trigger="blur" type="text" class="form-control" id="edit_username"  name="username" placeholder="请输入用户名名称必须唯一">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input data-bv-trigger="blur" type="password" class="form-control" id="edit_password"  name="password" placeholder="请输入密码">
                        </div>
                    </div>
...
<!-- 自定义 user.js -->
<script src="${ctx }/static/js/manage/user.js?v=1.0.0"></script>
