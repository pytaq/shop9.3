...
function initTable() {
    ...
    $tb.bootstrapTable({
        ...
        url: projectName + "/admin/manage/category/search",         //后台的服务器地址
        ...
        columns: [
            ...
            },
            {
                ...
                title: '推荐',
                align: 'center',
                formatter: IcomFormatter //格式化显示的内容
            },
            {
                field: 'enabled',
                title: '是否开启',
...
function operateFormatter(value, row, index) {
    if (row._level < 2) {
        return [
            '<button type="button" class="categoryOfAddChild btn   btn-primary" style="margin-right:15px;"><i class="fa fa-plus" ></i>&nbsp;新增子产品</button>',
...
function saveFormData() {
    ...
    setTimeout(function () {
        ...
        $.ajax({
            type: "POST",
            url: projectName + "/admin/manage/category/save",
            //向后台发送的数据
            data: dataStr,
            //返回json格式
            dataType: "json",
